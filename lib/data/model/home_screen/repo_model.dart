...
RepositoryModel repoModelFromJson(String str) =>
    RepositoryModel.fromJson(json.decode(str));

String repoModelToJson(RepositoryModel data) => json.encode(data.toJson());
...
class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) => Item(
        ...
        stargazersCount: json["stargazers_count"].toDouble(),
        watchersCount: json["watchers_count"].toDouble(),
        ...
        forksCount: json["forks_count"].toDouble(),
        mirrorUrl: json["mirror_url"],
        archived: json["archived"],
        disabled: json["disabled"],
        openIssuesCount: json["open_issues_count"].toDouble(),
        license:
        ...
        forks: json["forks"].toDouble(),
        openIssues: json["open_issues"].toDouble(),
        watchers: json["watchers"].toDouble(),
